...
export const Icon = {
  ...
  rocket: () => (<svg viewBox="0 0 24 24" {...s}><path d="M5 15c-1.5 1.5-2 5-2 5s3.5-.5 5-2" /><path d="M14 4c3 0 6 3 6 3s0 5-4 9c-1.6 1.6-4 3-4 3l-3-3-3-3s1.4-2.4 3-4c4-4 5-5 5-5Z" /><circle cx="14.5" cy="9.5" r="1.5" /></svg>),
